...
TURNSTILE_COMPONENT_URL = os.getenv(
    "TURNSTILE_COMPONENT_URL",
    "https://kok75522727-beep.github.io/One-Team/turnstile_component/",
)
TURNSTILE_COMPONENT = components.declare_component(
    "mgkhant_turnstile",
    url=TURNSTILE_COMPONENT_URL,
)
...
def validate_turnstile_token(token: str) -> bool:
    ...
    try:
        ...
        allowed_hosts = {
            "one-team-jubmgy3kapcfuwhy2wvpqu.streamlit.app",
            "kok75522727-beep.github.io",
        }
        return bool(response.ok and payload.get("success") and hostname in allowed_hosts)

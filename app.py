...
def render_paused_frame_editor(video_path: Path, duration_seconds: float) -> None:
    ...
    canvas_background = frame.convert("RGB").resize((canvas_width, canvas_height), Image.Resampling.LANCZOS)
    ...
    result = st_canvas(
        background_image=canvas_background, width=canvas_width, height=canvas_height, drawing_mode="transform",
        initial_drawing={"version": "4.4.0", "objects": canvas_objects}, background_color="#080d19",

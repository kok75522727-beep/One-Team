...
st.markdown(
    ...
    .stTabs [data-baseweb="tab-list"] { gap:.5rem; background:#0a1326; padding:.4rem; margin-top:.55rem; border:1px solid #33598d; border-radius:12px; }
    .stTabs [data-baseweb="tab"] { height:2.2rem; padding:0 .75rem; border-radius:8px; color:#b9cae4; font-size:.78rem; font-weight:700; }
    .stTabs [aria-selected="true"] { background:linear-gradient(90deg,#ffc857,#ff9966); color:#151b2d; }
    ...
    div[data-baseweb="select"] > div, div[data-baseweb="input"] > div { background:#101c33 !important; border-color:#4f76ad !important; color:#eef6ff !important; }
    div[data-baseweb="select"] * , div[data-baseweb="input"] input { color:#eef6ff !important; }
    ...
    @media (max-width: 720px) {
      ...
      .stTabs [data-baseweb="tab"] { padding:0 .38rem; font-size:.64rem; }
    }
    </style>
    """,

...
def render_paused_frame_editor(video_path: Path, duration_seconds: float) -> None:
    ...
    preview_width, preview_height = canvas_dimensions(frame, maximum_side=520)
    ...
    editor_result = DIRECT_VIDEO_EDITOR(
        ...
        key=f"direct_original_video_editor_{video_path.stat().st_mtime_ns}_{round(frame_time, 1)}",
        default=None,
    )
